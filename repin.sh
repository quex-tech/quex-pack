...
echo "    After committing, update QUEX_PACK_COMMIT (and the builder tag if it"
echo "    changed) in consumers — e.g. injective-core-quex/scripts/deploy.env —"
echo "    so verifiers fetch this exact tree."
