...
# Build init
ARG INIT_BIN_SHA256=6627ab5ed50bd4114239ecc88b70a35d0b6c2003fba6cba63a14289158d03062
...
ARG BASE_ROOTFS_CPIO_GZ_SHA256=bc3190a015456bc30b540ac8de501bf24249167e0a291d145be40930caefa42c
RUN <<EOF
#!/bin/bash
set -euo pipefail
cd ${ROOTFS_DIR}
