...
# Build init
ARG INIT_CFLAGS=""
ARG INIT_BIN_SHA256=c2a29db87da2cd3f6b593f4c1bf9af1fde5c0cd277268f00ef2ddcec167ed475
...
ARG ROOTFS_CPIO_GZ_SHA256=6fb7cc4a92669ea0f0ae88c41342f2826b9acf06dffb982bc06a98a4c50db0d0
RUN <<EOF
cd ${ROOTFS_DIR}
