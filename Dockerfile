...
# Build init
ARG INIT_CFLAGS=""
ARG INIT_BIN_SHA256=fc96a7cc47b722c235a5f62b68066747674795c4a4cacdd76b8e04bc5993616b
...
ARG ROOTFS_CPIO_GZ_SHA256=8da9f9ef61ca404d03d7fea4ca4244995211f860afa88ac1de1e73218a2484a3
RUN <<EOF
cd ${ROOTFS_DIR}
