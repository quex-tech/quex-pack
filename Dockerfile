...
# Build init
ARG INIT_CFLAGS=""
ARG INIT_BIN_SHA256=27b6cf76995060740efcd59f49da1cef9694f340da7cf2fec93d0901fbebaed0
...
ARG ROOTFS_CPIO_GZ_SHA256=f32d06c6230badee0ebf06c8cc6b50a9c836eb44025e1a0f572b016337b882b8
RUN <<EOF
cd ${ROOTFS_DIR}
