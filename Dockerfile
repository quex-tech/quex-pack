...
# Build init
ARG INIT_CFLAGS=""
ARG INIT_BIN_SHA256=bbb766a0cb16d525aa44ce1b743300cd610deaa229576be2b85e7f2995a3d85f
...
ARG ROOTFS_CPIO_GZ_SHA256=3a89c590926961c82150156e34b68639a706022d813d38704154e4eab60d5e1c
RUN <<EOF
cd ${ROOTFS_DIR}
