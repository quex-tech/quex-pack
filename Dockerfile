...
# Build init
ARG INIT_CFLAGS=""
ARG INIT_BIN_SHA256=8067a06f31d89a306372f3dab382a756b373022f62d74825a915c962616b2093
...
ARG ROOTFS_CPIO_GZ_SHA256=0554c2c7e97e33fcdc7f51f8e11d3929cf1430695e9e617700998a9cca27958c
RUN <<EOF
#!/bin/bash
set -euo pipefail
cd ${ROOTFS_DIR}
